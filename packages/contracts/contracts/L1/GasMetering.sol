...
abstract contract GasMetering {
    ...
    uint8 constant internal ELASTICITY_MULTIPLIER = 2;
    uint8 constant internal BASE_FEE_MAX_CHANGE_DENOMINATOR = 8;
    ...
    function _initialize(
        ...
        storage2 = SlotPacking128x128.set(
            gasTargetLimit,
            gasSanityLimit
        );
    }
