...
func l2Geth(cfg *systemConfig) (*node.Node, *eth.Ethereum, error) {
	return createGethNode(true, cfg.l2Verifier.nodeConfig, cfg.l2Verifier.ethConfig, []*ecdsa.PrivateKey{})
}

func l2SequencerGeth(cfg *systemConfig) (*node.Node, *eth.Ethereum, error) {
	return createGethNode(true, cfg.l2Sequencer.nodeConfig, cfg.l2Sequencer.ethConfig, []*ecdsa.PrivateKey{})
}
