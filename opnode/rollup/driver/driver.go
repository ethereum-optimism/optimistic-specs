...
func NewDriver(cfg rollup.Config, l2 *l2.Source, l1 *l1.Source, log log.Logger, snapshotLog log.Logger, sequencer bool) *Driver {
	output := &outputImpl{
		Config: cfg,
		dl:     l1,
		l2:     l2,
	...
	return &Driver{
		s: NewState(log, snapshotLog, cfg, l1, l2, output, sequencer),
	}
}
